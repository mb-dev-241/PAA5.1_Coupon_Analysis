...
The dataset contains data related to coupons for various business types presented to drivers when driving. Demographic information is available for the scenarios presented as well as whether the driver accepted the coupon in each scenario presented.
